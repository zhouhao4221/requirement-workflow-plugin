...
diag_deny "SSH 远程命令含非白名单动词：${VIOLATIONS}。白名单包含 tail/head/cat/grep/awk/sed/less/wc/find/ls/ps/df/free/uptime/stat/readlink/file/echo/sort/uniq/cut/tr 等只读命令。"
